    ...
    <aside className="fixed left-0 top-0 h-screen w-64 deltaways-nav shadow-lg z-50 overflow-y-auto">
      ...
      <div className="border-t border-gray-200 p-2 bg-gray-50">
        <div className="flex justify-center mb-2">
          <Link href="/website-analytics">
            <button className="p-2 rounded-lg hover:bg-gray-200 transition-colors duration-200 group">
              <Activity className="h-5 w-5 text-gray-600 group-hover:text-[#07233e]" />
            </button>
          </Link>
        </div>
      </div>
