      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
        ...
        <div className="flex items-center space-x-4">
          <Select value={timeRange} onValueChange={setTimeRange}>
            ...
            <SelectContent>
              <SelectItem value="7d">7 {t('time.days')}</SelectItem>
              <SelectItem value="30d">30 {t('time.days')}</SelectItem>
              <SelectItem value="90d">90 {t('time.days')}</SelectItem>
              <SelectItem value="1y">1 {t('time.year')}</SelectItem>
            </SelectContent>
          </Select>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-8">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">{t('analytics.totalUpdates')}</CardTitle>
            <TrendingUp className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{(stats.totalUpdates || 0).toLocaleString()}</div>
            <p className="text-xs text-muted-foreground">
              +12.5% {t('analytics.currentMonth')}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">{t('dashboard.legalCases')}</CardTitle>
