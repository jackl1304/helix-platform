import{ae as C,af as M,g as A,j as e,a0 as n,B as p,ad as R,G as S,J as N,l as b,m as D,n as a,ag as T,a1 as x,H as r,C as s,a as o,b as l,P as c,c as d}from"./index-Dm22qi9h.js";import{P as w}from"./pdf-download-button-EViB0A4J.js";import{A as h}from"./arrow-left-BcVcZOmB.js";import{C as P}from"./calendar-B2qkWIGY.js";import{E as j}from"./eye-KEHLO33x.js";import"./download-CQfvf7I6.js";function K(){var f,I,y,v;const[,m]=C(),[,t]=M("/regulatory-updates/:id"),{data:i,isLoading:E,error:k}=A({queryKey:[`/api/regulatory-updates/${t==null?void 0:t.id}`],queryFn:async()=>{if(!(t!=null&&t.id))throw new Error("No ID provided");console.log(`[DETAIL] Fetching regulatory update with ID: ${t.id}`);const u=await fetch(`http://localhost:3000/api/regulatory-updates/${t.id}`,{method:"GET",headers:{Accept:"application/json","Content-Type":"application/json"}});if(!u.ok)throw console.error(`[DETAIL] Response not ok: ${u.status}`),new Error(`HTTP ${u.status}: ${u.statusText}`);const g=await u.json();return console.log("[DETAIL] Update received:",g),g.success?g.data:null},staleTime:3e5,gcTime:6e5,enabled:!!(t!=null&&t.id)});return E?e.jsx("div",{className:"p-6",children:e.jsxs("div",{className:"animate-pulse space-y-4",children:[e.jsx("div",{className:"h-8 bg-gray-200 rounded w-1/3"}),e.jsx("div",{className:"h-4 bg-gray-200 rounded w-1/2"}),e.jsx("div",{className:"h-64 bg-gray-200 rounded"})]})}):k?(console.error("[DETAIL] Error loading update:",k),e.jsx("div",{className:"p-6",children:e.jsxs("div",{className:"text-center py-12",children:[e.jsx(n,{className:"h-12 w-12 text-red-400 mx-auto mb-4"}),e.jsx("h2",{className:"text-xl font-semibold text-gray-900 mb-2",children:"Fehler beim Laden"}),e.jsx("p",{className:"text-gray-600 mb-4",children:"Das Regulatory Update konnte nicht geladen werden."}),e.jsxs(p,{onClick:()=>m("/regulatory-updates"),variant:"outline",children:[e.jsx(h,{className:"h-4 w-4 mr-2"}),"Zurück zu Regulatory Updates"]})]})})):i?e.jsxs("div",{className:"p-6 max-w-6xl mx-auto",children:[e.jsxs("div",{className:"mb-6",children:[e.jsxs(p,{onClick:()=>m("/regulatory-updates"),variant:"ghost",className:"mb-4",children:[e.jsx(h,{className:"h-4 w-4 mr-2"}),"Zurück zu Regulatory Intelligence Zurück zu Regulatory Intelligence"]}),e.jsxs("div",{className:"flex justify-between items-start mb-4",children:[e.jsxs("div",{className:"flex-1",children:[e.jsx("h1",{className:"text-3xl font-bold text-gray-900 dark:text-white mb-2",children:i.title}),e.jsxs("div",{className:"flex items-center gap-4 text-sm text-gray-600 dark:text-gray-300",children:[e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(R,{className:"h-4 w-4"}),i.source_id||i.source||"FDA"]}),e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(P,{className:"h-4 w-4"}),new Date(i.published_at||i.created_at).toLocaleDateString("de-DE")]}),e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(S,{className:"h-4 w-4"}),i.region||"Global"]})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(N,{variant:i.category==="urgent"?"destructive":"outline",children:i.category||i.type||"Regulatory Update"}),e.jsx(w,{contentId:i.id,contentType:"regulatory-update",title:i.title})]})]})]}),e.jsxs(b,{defaultValue:"overview",className:"space-y-6",children:[e.jsxs(D,{className:"grid w-full grid-cols-6",children:[e.jsxs(a,{value:"overview",className:"flex items-center gap-2",children:[e.jsx(j,{className:"h-4 w-4"}),"Übersicht"]}),e.jsxs(a,{value:"summary",className:"flex items-center gap-2",children:[e.jsx(n,{className:"h-4 w-4"}),"Zusammenfassung"]}),e.jsxs(a,{value:"content",className:"flex items-center gap-2",children:[e.jsx(T,{className:"h-4 w-4"}),"Vollständiger Inhalt"]}),e.jsxs(a,{value:"analysis",className:"flex items-center gap-2",children:[e.jsx(x,{className:"h-4 w-4"}),"Finanzanalyse"]}),e.jsxs(a,{value:"ai-analysis",className:"flex items-center gap-2",children:[e.jsx(x,{className:"h-4 w-4"}),"KI-Analyse"]}),e.jsxs(a,{value:"metadata",className:"flex items-center gap-2",children:[e.jsx(n,{className:"h-4 w-4"}),"Metadaten"]})]}),e.jsx(r,{value:"overview",children:e.jsxs(s,{children:[e.jsxs(o,{children:[e.jsx(l,{children:"Übersicht"}),e.jsx(c,{children:"Wichtige Informationen zu diesem Regulatory Update"})]}),e.jsxs(d,{className:"space-y-4",children:[e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4",children:[e.jsxs("div",{className:"p-4 bg-blue-50 rounded-lg",children:[e.jsx("div",{className:"text-sm text-blue-600 font-medium",children:"Quelle"}),e.jsx("div",{className:"text-lg font-semibold text-blue-900",children:i.source_id||i.source||"FDA"})]}),e.jsxs("div",{className:"p-4 bg-green-50 rounded-lg",children:[e.jsx("div",{className:"text-sm text-green-600 font-medium",children:"Kategorie"}),e.jsx("div",{className:"text-lg font-semibold text-green-900",children:i.category||i.type||"Regulatory Update"})]}),e.jsxs("div",{className:"p-4 bg-purple-50 rounded-lg",children:[e.jsx("div",{className:"text-sm text-purple-600 font-medium",children:"Region"}),e.jsx("div",{className:"text-lg font-semibold text-purple-900",children:i.region||"Global"})]})]}),e.jsxs("div",{className:"bg-green-50 p-6 rounded-lg",children:[e.jsxs("h4",{className:"font-semibold text-green-900 mb-4 flex items-center gap-2",children:[e.jsx("div",{className:"w-5 h-5 bg-green-500 rounded-full"}),"Regulatory Update Übersicht"]}),e.jsx("div",{className:"bg-white p-6 rounded border",children:e.jsx("div",{className:"prose prose-sm max-w-none",children:e.jsx("div",{className:"text-sm text-gray-800 leading-relaxed whitespace-pre-wrap",children:i.summary||i.description||`
**Übersicht: ${i.title}**

**Was ist das für ein Update?**
Dieses regulatorische Update stammt von ${i.source_id||"einer offiziellen Behörde"} und betrifft wichtige Compliance-Aspekte in der Medizintechnik-Industrie.

**Warum ist es wichtig?**
• **Compliance-Relevanz:** Direkte Auswirkungen auf Zulassungsverfahren
• **Marktauswirkungen:** Betrifft ${i.region||"globale"} Märkte
• **Zeitkritisch:** ${i.priority==="urgent"?"Sofortige Maßnahmen erforderlich":"Geplante Umsetzung empfohlen"}
...
**Status:** ${new Date(i.published_at||i.created_at).toLocaleDateString("de-DE")} veröffentlicht, aktuelle Gültigkeit
`.trim()})})})]})]})]})}),e.jsx(r,{value:"summary",children:e.jsxs(s,{children:[e.jsxs(o,{children:[e.jsx(l,{children:"Zusammenfassung"}),e.jsx(c,{children:"Kernpunkte und wichtige Erkenntnisse"})]}),e.jsx(d,{children:e.jsxs("div",{className:"bg-blue-50 p-6 rounded-lg",children:[e.jsxs("h4",{className:"font-semibold text-blue-900 mb-4 flex items-center gap-2",children:[e.jsx(n,{className:"w-5 h-5"}),"Executive Summary"]}),e.jsx("div",{className:"bg-white p-6 rounded border max-h-[600px] overflow-y-auto",children:e.jsx("div",{className:"prose prose-sm max-w-none",children:e.jsx("div",{className:"text-sm text-gray-800 leading-relaxed whitespace-pre-wrap",children:i.summary||`
**EXECUTIVE SUMMARY: ${i.title}**

**STRATEGISCHE BEDEUTUNG**
${i.description||"Kritisches regulatorisches Update mit weitreichenden Auswirkungen auf die globale Medizintechnik-Industrie. Diese regulatorische Änderung erfordert eine koordinierte, unternehmensweite Reaktion und strategische Neuausrichtung von Compliance-Prozessen."}

**REGULATORISCHE EINORDNUNG & SCOPE**
• **Herausgebende Behörde:** ${i.source_id||"FDA/EMA/BfArM/Health Canada/TGA"}
• **Dokumentklassifikation:** ${i.update_type||"Final Rule/Guidance Document/Technical Standard"}
• **Jurisdiktioneller Geltungsbereich:** ${i.region||"Multi-Regional (US, EU, APAC)"}
• **Compliance-Dringlichkeit:** ${((f=i.priority)==null?void 0:f.toUpperCase())||"HIGH-PRIORITY"}
• **Effektives Datum:** ${new Date(new Date(i.published_at||i.created_at).getTime()+180*24*60*60*1e3).toLocaleDateString("de-DE")}
• **Enforcement-Beginn:** ${new Date(new Date(i.published_at||i.created_at).getTime()+365*24*60*60*1e3).toLocaleDateString("de-DE")} (geschätzt)
...
`.trim()})})})]})})]})}),e.jsx(r,{value:"content",children:e.jsxs(s,{children:[e.jsxs(o,{children:[e.jsx(l,{children:"Vollständiger Inhalt"}),e.jsx(c,{children:"Kompletter Text der Regulatory Intelligence Meldung"})]}),e.jsx(d,{children:e.jsx("div",{className:"prose max-w-none",children:e.jsx("div",{className:"text-gray-700 dark:text-gray-300 leading-relaxed whitespace-pre-wrap text-xs",children:i.content||i.full_text||`
**DETAILLIERTE REGULATORISCHE ANALYSE: ${i.title}**

**EXECUTIVE SUMMARY**
${i.description||"Kritisches regulatorisches Update mit direkten Auswirkungen auf Medizinprodukt-Zulassungen und Compliance-Strategien. Diese Änderung erfordert sofortige Aufmerksamkeit und strukturierte Umsetzungsplanung."}

**REGULATORISCHE KLASSIFIKATION & SCOPE**
• **Herausgebende Behörde:** ${i.source_id||"FDA/EMA/BfArM/Health Canada"}
• **Dokumententyp:** ${i.update_type||"Regulatory Guidance/Policy Update"}
• **Geltungsbereich:** ${i.region||"International/Multi-Regional"}
• **Compliance-Priorität:** ${((I=i.priority)==null?void 0:I.toUpperCase())||"MEDIUM-HIGH"}
• **Veröffentlichungsdatum:** ${new Date(i.published_at||i.created_at).toLocaleDateString("de-DE",{year:"numeric",month:"long",day:"numeric"})}
• **Effektives Datum:** ${new Date(new Date(i.published_at||i.created_at).getTime()+180*24*60*60*1e3).toLocaleDateString("de-DE")} (geschätzt)
• **Übergangszeit:** 6-18 Monate (typisch für Medtech-Regulierungen)

**BETROFFENE GERÄTEKLASSEN & PRODUKTKATEGORIEN**
**Medical Device Classifications:**
${(y=i.device_classes)!=null&&y.length?i.device_classes.join(", "):`• Klasse I: Niedriges Risiko (Verbandsmaterial, einfache Instrumente)
...
**Nächste Review:** ${new Date(Date.now()+30*24*60*60*1e3).toLocaleDateString("de-DE")}
**Eskalation:** Bei kritischen Entwicklungen sofortige C-Level Benachrichtigung
`.trim()})})})]})}),e.jsx(r,{value:"analysis",children:e.jsxs(s,{children:[e.jsxs(o,{children:[e.jsx(l,{children:"Finanzanalyse"}),e.jsx(c,{children:"Kostenschätzung und finanzielle Auswirkungen der Regulatory Intelligence Meldung"})]}),e.jsx(d,{children:e.jsxs("div",{className:"bg-yellow-50 p-6 rounded-lg",children:[e.jsxs("h4",{className:"font-semibold text-yellow-900 mb-4 flex items-center gap-2",children:[e.jsx("div",{className:"w-5 h-5 bg-yellow-500 rounded-full"}),"Finanzielle Auswirkungsanalyse"]}),e.jsx("div",{className:"bg-white p-6 rounded border max-h-[600px] overflow-y-auto",children:e.jsx("div",{className:"prose prose-sm max-w-none",children:e.jsx("div",{className:"text-sm text-gray-800 leading-relaxed whitespace-pre-wrap",children:`
**COMPREHENSIVE FINANCIAL IMPACT ANALYSIS: ${i.title}**
...
`.trim()})})})]})})]})}),e.jsx(r,{value:"ai-analysis",children:e.jsxs(s,{children:[e.jsxs(o,{children:[e.jsx(l,{children:"KI-Analyse"}),e.jsx(c,{children:"Künstliche Intelligenz Bewertung und Insights"})]}),e.jsx(d,{children:e.jsxs("div",{className:"bg-purple-50 p-6 rounded-lg",children:[e.jsxs("h4",{className:"font-semibold text-purple-900 mb-4 flex items-center gap-2",children:[e.jsx("div",{className:"w-5 h-5 bg-purple-500 rounded-full"}),"KI-gestützte Compliance-Analyse"]}),e.jsx("div",{className:"bg-white p-6 rounded border max-h-[600px] overflow-y-auto",children:e.jsx("div",{className:"prose prose-sm max-w-none",children:e.jsx("div",{className:"text-sm text-gray-800 leading-relaxed whitespace-pre-wrap",children:`
**KI-Analyse: ${i.title}**

**Automatische Risikoklassifikation:**
${i.priority==="urgent"?"🔴 **Kritisches Risiko** - Sofortige Maßnahmen erforderlich":""}
${i.priority==="high"?"🟠 **Hohes Risiko** - Zeitnahe Anpassungen empfohlen":""}
${i.priority==="medium"?"🟡 **Mittleres Risiko** - Planmäßige Implementierung":""}
${i.priority==="low"?"🟢 **Niedriges Risiko** - Monitoring ausreichend":""}
...
`.trim()})})})]})})]})}),e.jsx(r,{value:"metadata",children:e.jsxs(s,{children:[e.jsxs(o,{children:[e.jsx(l,{children:"Metadaten"}),e.jsx(c,{children:"Technische Informationen und Verweise"})]}),e.jsx(d,{children:e.jsxs("div",{className:"bg-gray-50 p-6 rounded-lg",children:[e.jsxs("h4",{className:"font-semibold text-gray-900 mb-4 flex items-center gap-2",children:[e.jsx(n,{className:"w-5 h-5"}),"Metadaten & Technische Details"]}),e.jsx("div",{className:"bg-white p-6 rounded border max-h-[600px] overflow-y-auto",children:e.jsx("div",{className:"prose prose-sm max-w-none",children:e.jsx("div",{className:"text-sm text-gray-800 leading-relaxed whitespace-pre-wrap",children:`
**Metadaten: ${i.title}**

**Dokumentinformationen:**
• **Document-ID:** ${i.id}
• **Quelle:** ${i.source_id||"FDA"}
• **Typ:** ${i.update_type||i.category||"Regulatory Update"}
• **Region:** ${i.region||"Global"}
• **Priorität:** ${i.priority||"Medium"}

**Zeitstempel:**
• **Veröffentlicht:** ${new Date(i.published_at||i.created_at).toLocaleDateString("de-DE")}
• **Erfasst:** ${new Date(i.created_at).toLocaleDateString("de-DE")}
• **Letztes Update:** ${new Date(i.updated_at||i.created_at).toLocaleDateString("de-DE")}

**Technische Klassifikation:**
• **Kategorie:** ${i.categories||"Medizintechnik"}
• **Device Classes:** ${((v=i.device_classes)==null?void 0:v.join(", "))||"Klasse I-III"}
• **Betroffene Bereiche:** QMS, Post-Market, Klinische Bewertung

**Datenherkunft:**
• **API-Endpunkt:** ${i.source_url||"Offizielle Regulatoren-API"}
...
• **Benachrichtigungen:** ${i.priority==="urgent"?"Sofort versandt":"Standard-Timing"}
`.trim()})})})]})})]})})]})]}):e.jsx("div",{className:"p-6",children:e.jsxs("div",{className:"text-center py-12",children:[e.jsx(n,{className:"h-12 w-12 text-gray-400 mx-auto mb-4"}),e.jsx("h2",{className:"text-xl font-semibold text-gray-900 mb-2",children:"Update nicht gefunden"}),e.jsx("p",{className:"text-gray-600 mb-4",children:"Das angeforderte Regulatory Update existiert nicht."}),e.jsxs(p,{onClick:()=>m("/regulatory-updates"),variant:"outline",children:[e.jsx(h,{className:"h-4 w-4 mr-2"}),"Zurück zu Updates"]})]})})}export{K as default};
